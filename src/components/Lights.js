...
const Lights = ({mode, toggleMode}) => {
  ...
  const [width, setWidth] = useState({
    topLights: "100%",
    sideLights: "20%",
    topLightsTruncated: "100%"
  })
  const [height, setHeight] = useState({
    topLights: "20%",
    sideLights: "100%",
    topLightsTruncated: "20%"
  })
  ...
  const topLights = () => {
    ...
    >
      ...
      >
        ...
        <path d="m 334.6,15.528 c 2.91721,-8.2235473 5.70731,4.180328 0,0 z"/>
        <path d="m 345.17,20.662 c -4.69889,-5.499786 -5.2551,3.885932 0,0 z"/>
        <path d="m 340.04,28.75 c 5.83238,-6.525754 3.69857,6.005472 0,0 z"/>
        <path d="m 356.39,20.673 c 4.02458,7.73927 -6.98739,1.249343 0,0 z"/>
        <path d="m 351.51,32.251 c 0.56174,-7.180728 6.56948,0.112607 0,0 z"/>
        <path d="m 309.02,21.337 c 6.66961,5.661321 -5.99554,3.776247 0,0 z"/>
        <path d="m 320.31,23.321 c -5.66966,-6.647549 6.52774,-2.773134 0,0 z"/>
        <path d="m 366.5,28.579 c -4.87649,-5.33821 4.60269,-4.656685 0,0 z"/>
        <path d="m 370.38,11.234 c 6.97959,5.303271 2.47899,-6.5946864 0,0 z"/>
        <path d="m 376.37,20.432 c -7.6125,-4.362682 -1.59925,6.857951 0,0 z"/>
        <path d="m 382.6,4.2167 c -6.58941,3.0405193 2.40598,6.059431 0,0 z"/>
        <path d="m 384.12,28.663 c 5.92859,-6.421487 -6.41294,-3.025696 0,0 z"/>
        <path d="m 396.02,31.777 c -2.12678,-8.457663 -6.0772,3.632237 0,0 z"/>
        <path d="m 389.91,14.945 c -5.49721,4.718416 -4.5892,-4.638341 0,0 z"/>
        <path d="m 405.12,29.713 c -4.35833,-5.76119 5.01795,-4.215664 0,0 z"/>
        <path d="m 403.4,16.753 c 3.53977,7.98203 5.36865,-4.597804 0,0 z"/>
        <path d="m 415.41,17.368 c -5.87161,-4.243636 3.54648,-5.486445 0,0 z"/>
        <path d="m 418.47,7.1346 c 4.36622,7.568254 4.85444,-5.1317418 0,0 z"/>
        <path d="m 432.52,9.9059 c -5.37968,4.849423 -4.70175,-4.5267195 0,0 z"/>
        <path d="m 424.52,17.627 c 8.48706,-2.272864 -0.23293,7.035371 0,0 z"/>
        <path d="m 430.23,30.532 c 0.97366,-8.662539 6.50843,2.799598 0,0 z"/>
        <path d="m 448.05,31.237 c -5.86974,-4.245959 3.54853,-5.485079 0,0 z"/>
        <path d="m 457.52,18.339 c -2.11287,6.892654 -6.38582,-1.511028 0,0 z"/>
        <path d="m 466.71,8.2025 c -2.11295,6.892647 -6.38575,-1.5107555 0,0 z"/>
        <path d="m 468.28,21.779 c 3.83901,-6.101985 5.7699,3.1257 0,0 z"/>
        <path d="m 485,26.974 c -2.07741,-6.903451 6.14756,-2.29582 0,0 z"/>
        <path d="m 496.9,18.386 c -5.06173,-5.133302 -4.96253,4.29366 0,0 z"/>
        <path d="m 497.1,8.6077 c 2.54734,6.744132 6.2767,-1.9141623 0,0 z"/>
        <path d="m 513.49,8.7795 c -7.14553,0.9554537 0.44452,6.547101 0,0 z"/>
        <path d="m 516.63,21.045 c 4.0437,-5.968291 -5.18148,-4.026545 0,0 z"/>
        <path d="m 525.07,6.7216 c -4.93909,5.251428 4.47705,4.797426 0,0 z"/>
        <path d="m 529.04,26.267 c -0.44167,-7.195635 -6.56217,-0.02494 0,0 z"/>
